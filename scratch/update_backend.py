...
portfolio_service_content = '''import asyncio
import logging
import uuid
...
target_path = r'C:\Users\SREENAND PK\Desktop\Trading\market-service\src\market_service\services\portfolio_service.py'
with open(target_path, 'w', encoding='utf-8') as f:
    f.write(portfolio_service_content)

print('portfolio_service.py updated successfully')
