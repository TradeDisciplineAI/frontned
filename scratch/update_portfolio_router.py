...
async def create_portfolio(
    ...
    portfolio_in: PortfolioCreate = PortfolioCreate(),
) -> PortfolioResponse:
...
target_path = r'C:\Users\SREENAND PK\Desktop\Trading\market-service\src\market_service\routers\portfolio.py'
with open(target_path, 'w', encoding='utf-8') as f:
    f.write(content)

print('portfolio router updated successfully')
